...
if os.name == 'posix':
    ...
    print ("\nTa-dah! File created.\nYou can find it at: /Users/"+cid+"/Desktop/"+new_ids+".txt") #Message that the convertion is correct
...
if os.name == 'nt':
    ...
    print("Working...")
    time.sleep(1) #Dramatic pause
    print ("\nTa-dah! File created.\nYou can find it at: "+harddrive+":\\Users\\"+cid+".NET\\Desktop"+new_ids+".txt") #Message that the convertion is correct
